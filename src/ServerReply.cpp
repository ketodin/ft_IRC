...
static std::string
makeReply(const Code& code, const Client& client, const Channel* channel, const std::string* extra)
{
	...
	switch (code)
	{
        ...
        case RPL_WELCOME:
        	...
        	break ;
        case RPL_YOURHOST:
        	rplMsg = ":Your host is " + Server::getInstance()->getServerName() + ", running version 1.0";
        	break ;
        case RPL_CREATED:
        	rplMsg = ":This server was created " + Server::getInstance()->getCreationDate();
        	break ;
        case RPL_MYINFO:
        	rplMsg = Server::getInstance()->getServerName() + " 1.0 :Available channel modes: itkol";
        	break ;
        ...
        case ERR_USERNOTINCHANNEL: 
        	rplMsg = *extra + " " + channel->getName() + " :They aren't on that channel";
        	break ;
        case ERR_USERONCHANNEL:    
        	rplMsg = *extra + " " + channel->getName() + " :is already on channel";
        	break ;
...
void
reply(const Client& client, const Channel& channel, const Code& code, const std::string& extra)
{
