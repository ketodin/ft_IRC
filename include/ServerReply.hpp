...
//std::string makeReply(const Code& code, const Client& client, const Channel& channel, const std::string& extra);
...
void reply(const Client& client, const Channel& channel, const Code& code, const std::string& extra);
}
